...
fetch('https://mindhub-xj03.onrender.com/api/petshop')
            ...
            .then(respuesta => {
                ...
                let farmacia = todasLasCartas.filter(producto => producto.categoria == "farmacia")
                console.log(todasLasCartas)
                console.log(farmacia)
                crearCarta(farmacia,$template)
...
const $carrito = document.getElementById("offcanvasRight")
...
let men= menor(farmacia,$categoria1.checked)
...
let may=mayor(farmacia,$categoria2.checked)
